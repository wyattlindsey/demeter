...
var CSSPropertyOperations = { 
   ...
   * @return {?string}
   */
  createMarkupForStyles: function /*istanbul ignore next*/createMarkupForStyles(styles) {
    var serialized = '';
   ...
   * @param {object} styles
   */
  setValueForStyles: function /*istanbul ignore next*/setValueForStyles(node, styles) {
