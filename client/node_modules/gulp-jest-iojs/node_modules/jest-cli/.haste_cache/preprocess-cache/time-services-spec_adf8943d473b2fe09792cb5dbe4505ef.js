...
describe("Time Services conversion functions", function () {
  ...
  it("should convert from days after new year on new year's itself", function () {
    let newYearsDay = TimeServices.convertFromDaysAfterNewYear(0);
    expect(newYearsDay.month).toBe(0);
    expect(newYearsDay.date).toBe(1);});
  ...
  it("should give days since New Year's when provided a date", function () {
  ...
  it("should return false if no date is passed to the above function", function () {
