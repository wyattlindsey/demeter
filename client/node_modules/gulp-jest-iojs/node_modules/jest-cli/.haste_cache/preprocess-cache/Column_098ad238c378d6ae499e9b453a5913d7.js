/*istanbul ignore next*/'use strict';module.exports = function (React) {
  return React.createClass({ 
    ...
    getDefaultProps: function /*istanbul ignore next*/getDefaultProps() {
      return { 
        className: '', 
        extraSmall: 0, 
        extraSmallOffset: 0, 
    ...
    getColumnWidths: function /*istanbul ignore next*/getColumnWidths() {
      var colWidths = [];
    ...
    getColumnOffsets: function /*istanbul ignore next*/getColumnOffsets() {
      var offsets = [];
    ...
    getColumnPush: function /*istanbul ignore next*/getColumnPush() {
      var pushes = [];
    ...
    getColumnPull: function /*istanbul ignore next*/getColumnPull() {
      var pulls = [];
