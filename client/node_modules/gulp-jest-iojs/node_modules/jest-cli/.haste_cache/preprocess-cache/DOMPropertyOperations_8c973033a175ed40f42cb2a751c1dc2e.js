...
var DOMPropertyOperations = { 
   ...
   */
  createMarkupForID: function /*istanbul ignore next*/createMarkupForID(id) {
    return DOMProperty.ID_ATTRIBUTE_NAME + '=' + quoteAttributeValueForBrowser(id);}, 


  setAttributeForID: function /*istanbul ignore next*/setAttributeForID(node, id) {
   ...
   */
  createMarkupForProperty: function /*istanbul ignore next*/createMarkupForProperty(name, value) {
   ...
   */
  createMarkupForCustomAttribute: function /*istanbul ignore next*/createMarkupForCustomAttribute(name, value) {
   ...
   * @param {*} value
   */
  setValueForProperty: function /*istanbul ignore next*/setValueForProperty(node, name, value) {
    var propertyInfo = DOMProperty.properties.hasOwnProperty(name) ? DOMProperty.properties[name] : null;
    if (propertyInfo) {
  ...
  setValueForAttribute: function /*istanbul ignore next*/setValueForAttribute(node, name, value) {
   ...
   * @param {string} name
   */
  deleteValueForProperty: function /*istanbul ignore next*/deleteValueForProperty(node, name) {
    var propertyInfo = DOMProperty.properties.hasOwnProperty(name) ? DOMProperty.properties[name] : null;
    if (propertyInfo) {
      var mutationMethod = propertyInfo.mutationMethod;
      if (mutationMethod) {
