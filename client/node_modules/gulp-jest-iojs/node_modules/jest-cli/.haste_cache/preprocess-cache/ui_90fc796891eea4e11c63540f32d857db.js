...
var q = require('q'); /*istanbul ignore next*/var _class = function () {
  ...
  function /*istanbul ignore next*/_class(settings) {/*istanbul ignore next*/_classCallCheck(this, _class);
    ...
    this.state.currentInteractiveCommand = 'none';}_createClass(_class, [{ key: 'getCommands', value: function getCommands() 
    ...
    action) {
      ...
      {// click component
        var component = findByID(this.state.components, action.targetID);
...
function clickViewport(action, state) {
    ...
    return;} else 
  {
    if (typeof state.currentInteractiveCommand.handleClick === 'undefined') {
      throw new Error('command is missing handleClick function');} else 
    {
