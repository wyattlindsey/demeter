...
var Tabs = _react2['default'].createClass({ 
  ...
  renderTab: function renderTab(child, index) {
    ...
    { 
      ...
      ref: function /*istanbul ignore next*/ref(_ref3) {
  ...
  getColProps: function getColProps(_ref) {
    ...
    if (paneWidth == null) {
      ...
      _Object$keys(tabsColProps).forEach(function (size) {
        panesColProps[size] = _styleMaps2['default'].GRID_COLUMNS - tabsColProps[size];});} else 

    if (paneWidth instanceof Object) {
      panesColProps = paneWidth;} else 
    {
