...
internals.checkOptions = function (options) {
    ...
    for (var i = 0; i < keys.length; ++i) {
        ...
        Hoek.assert( /*istanbul ignore next*/_typeof(options[key]) === type, key + ' should be of type ' + type);
        if (values) {
                    ...
                    for (var _j = 0; _j < source.length; ++_j) {
                        ...
                        if (keys[sourceKey] >= 0) {
                            target[keys[sourceKey]] = { 
                                key: sourceKey, 
                                schema: target[keys[sourceKey]].schema.concat(source[_j].schema) };} else 


                        {
                            target.push(source[_j]);}}} else 



                {
                    obj._inner[key] = obj._inner[key].concat(source);}} else 
...
internals.Any.prototype.when = function (ref, options) {
    ...
    Hoek.assert(options && /*istanbul ignore next*/(typeof options === 'undefined' ? 'undefined' : _typeof(options)) === 'object', 'Invalid options');
...
internals.Any.prototype._validate = function (value, state, options, reference) {/*istanbul ignore next*/var _this = this;
    ...
    var finish = function finish() {
        ...
        var finalValue = /*istanbul ignore next*/void 0;

        if (! /*istanbul ignore next*/_this._flags.strip) {
            if (value !== undefined) {
                finalValue = options.raw ? originalValue : value;} else 

            if (options.noDefaults) {
                finalValue = originalValue;} else 

            if (Ref.isRef( /*istanbul ignore next*/_this._flags.default)) {
                finalValue = /*istanbul ignore next*/_this._flags.default(state.parent, options);} else 

            if (typeof /*istanbul ignore next*/_this._flags.default === 'function' && 
            !( /*istanbul ignore next*/_this._flags.func && ! /*istanbul ignore next*/_this._flags.default.description)) {

                var arg = /*istanbul ignore next*/void 0;

                if (state.parent !== null && 
                /*istanbul ignore next*/_this._flags.default.length > 0) {

                    arg = Hoek.clone(state.parent);}


                var defaultValue = internals._try( /*istanbul ignore next*/_this._flags.default, arg);
                finalValue = defaultValue.value;
                if (defaultValue.error) {
                    errors.push( /*istanbul ignore next*/_this.createError('any.default', defaultValue.error, state, options));}} else 


            {
                finalValue = Hoek.clone( /*istanbul ignore next*/_this._flags.default);}}
    ...
    if (flags.length) {
        if (this._flags.hasOwnProperty('empty') || this._flags.hasOwnProperty('default')) {
            ...
            for (var i = 0; i < flags.length; ++i) {
                var flag = flags[i];
                if (flag === 'empty') {
                    description.flags[flag] = this._flags[flag].describe();} else 

                if (flag === 'default') {
                    if (Ref.isRef(this._flags[flag])) {
                        description.flags[flag] = this._flags[flag].toString();} else 

                    if (typeof this._flags[flag] === 'function') {
                        description.flags[flag] = this._flags[flag].description;} else 
...
internals.Set.prototype.remove = function (value) {
    ...
    this._set = this._set.filter(function (item) /*istanbul ignore next*/{return value !== item;});};
...
internals.Set.prototype.has = function (value, state, options, insensitive) {
    ...
    for (var i = 0; i < this._set.length; ++i) {
        ...
        for (var j = 0; j < items.length; ++j) {
            var item = items[j];
            if ( /*istanbul ignore next*/(typeof value === 'undefined' ? 'undefined' : _typeof(value)) !== /*istanbul ignore next*/(typeof item === 'undefined' ? 'undefined' : _typeof(item))) {
                continue;}
