...
function onlyProgressBar(props, propName, componentName) {
  if (props[propName]) {
    ...
    if ( /*istanbul ignore next*/(typeof _ret === 'undefined' ? 'undefined' : _typeof(_ret)) === 'object') return _ret.v;}}
...
var ProgressBar = function (_React$Component) {
  ...
  ProgressBar.prototype.render = function render() {
    ...
    if (this.props.children) {
      content = _utilsValidComponentChildren2['default'].map(this.props.children, this.renderChildBar);} else 
    {
