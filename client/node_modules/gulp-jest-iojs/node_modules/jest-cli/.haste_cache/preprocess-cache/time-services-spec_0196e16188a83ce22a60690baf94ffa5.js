...
describe("Time Services conversion functions", function () {
  ...
  it("should convert from days after new year", function () {
    let summerSolstice = new TimeServices.convertFromDaysAfterNewYear(171, 2015);
    expect(summerSolstice.month).toBe(5);
    expect(summerSolstice.date).toBe(21);

    /* check for leap year feb 29 2016 */
    let leapYearDay = new TimeServices.convertFromDaysAfterNewYear(60, 2016);
    expect(summerSolstice.month).toBe(1);
    expect(summerSolstice.date).toBe(29);});});